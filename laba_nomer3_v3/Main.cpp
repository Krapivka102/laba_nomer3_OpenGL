...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "laba3", NULL, NULL);
	if (window == NULL)
	{
	...
	// Генерирует объект Shader, используя шейдеры default.vert и default.frag
	...
	Texture blockmain("../Resources/block3.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	blockmain.texUnit(shaderProgram, "tex0", 0);
